...
const Solutions = () => {
    return (
        <div className='h-[799px] max-md:h-[1324px] bg-white flex flex-col space-y-20 max-md:space-y-10 items-center justify-center w-full'>
            <p className='text-[#080808] text-center md:w-[782px] max-md:text-[24px] max-md:max-w-[90%] max-md:leading-[2.5rem] max-md:pt-10 max-md:text-left text-[56px] leading-[4rem] font-semibold'>Digitale Lösungen, maßgeschneidert für eine <span className='text-deep-purple'>Vielzahl von Branchen.</span></p>
            <div className='w-[1256px] max-md:h-[1024px] max-md:w-[90%]  md:h-[376px] flex flex-col items-center md:justify-between'>
                <div className='w-full items-center justify-between flex flex-row max-md:flex-col max-md:space-y-5 '>
                    <div className='flex flex-col px-5 py-5 space-y-3 w-[302px] max-md:w-full h-[180px] max-md:h-[104px] max-md:space-y-2'>

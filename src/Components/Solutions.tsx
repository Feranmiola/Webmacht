...
const Solutions = () => {
    return (
        <div className='h-[799px] max-md:h-[1324px] md:h-auto lg:h-auto bg-white flex flex-col space-y-20 max-md:space-y-10 items-center justify-center w-full py-20'>
            <p className='text-[#080808] text-center md:w-[782px] max-md:text-[24px] max-md:max-w-[90%] max-md:leading-[2.5rem] max-md:pt-10 max-md:text-left md:text-[40px] lg:text-[56px] md:leading-[3.5rem] lg:leading-[4rem] font-semibold'>Digitale Lösungen, maßgeschneidert für eine <span className='text-deep-purple'>Vielzahl von Branchen.</span></p>
            <div className='w-[1256px] max-md:h-[1024px] max-md:w-[90%] md:w-[90%] lg:w-[1256px] md:h-auto lg:h-[376px] flex flex-col items-center md:justify-between'>
                <div className='w-full items-center justify-between flex flex-row max-md:flex-col max-md:space-y-5 md:flex-wrap lg:flex-nowrap md:gap-5 lg:gap-0'>
                    <div className='flex flex-col px-5 py-5 space-y-3 w-[302px] max-md:w-full md:w-[45%] lg:w-[302px] h-[180px] max-md:h-[104px] md:h-[160px] lg:h-[180px] max-md:space-y-2'>
                ...
                <div className='w-full items-center justify-between flex flex-row max-md:flex-col max-md:space-y-5 md:flex-wrap lg:flex-nowrap md:gap-5 lg:gap-0 md:mt-5 lg:mt-0'>
                    <div className='flex flex-col px-5 py-5 space-y-3 w-[302px] max-md:w-full md:w-[45%] lg:w-[302px] h-[180px] max-md:h-[104px] md:h-[160px] lg:h-[180px] max-md:space-y-2'>
